...
def predictions_etl_pipeline():
    ...
    def load(db_configs, history):
        ...
        update_table(db_configs["BI"], "AHJ_Predictions_DotCare", pred_df, logger)
        update_table(db_configs["AI"], "Claims_Predictions_History", history, logger)
    ...
    loaded = load(db_configs, transformed)

    loaded >> cleanup_extraction_file(extracted, transformed)
